...
(cl:in-package flyback_panda-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name flyback_panda-msg:<Num> is deprecated: use flyback_panda-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader flyback_panda-msg:num-val is deprecated.  Use flyback_panda-msg:num instead.")
  (num m))
