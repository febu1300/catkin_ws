...
get_filename_component(_filename "/home/buruk/catkin_ws/src/qt_ros/qt_tutorials/srv/TwoInts.srv" NAME_WE)
add_custom_target(_qt_tutorials_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "qt_tutorials" "/home/buruk/catkin_ws/src/qt_ros/qt_tutorials/srv/TwoInts.srv" ""
)
...
_generate_srv_cpp(qt_tutorials
  "/home/buruk/catkin_ws/src/qt_ros/qt_tutorials/srv/TwoInts.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/qt_tutorials)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/qt_tutorials\")")
  # install generated code
  install(
